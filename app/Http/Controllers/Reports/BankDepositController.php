...
class BankDepositController extends Controller
{
    ...
    public function pdf(Request $request, PdfService $pdf)
    {
        ...
        return $pdf
            ->make("reports.pdf.bank-deposit", array_merge(
                [
                    "shopId" => $shopId,
                    "startDate" => $startDate,
                    "endDate" => $endDate,
    ...
    public function excel(Request $request, ExcelService $excelService)
    {
        ...
        $sheetTitle = "Bank Deposit {$startDate} to {$endDate}";
        $fileName = "bank_deposit_{$startDate}_{$endDate}.xlsx";

        return $excelService->export(
            view("reports.excel.bank-deposit", array_merge(
                [
                    "shopId" => $shopId,
                    "startDate" => $startDate,
                    "endDate" => $endDate,
