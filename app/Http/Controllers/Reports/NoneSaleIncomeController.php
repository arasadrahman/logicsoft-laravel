...
class NoneSaleIncomeController extends Controller
{
    public function index(Request $request)
    {
        $pageTitle = "None Sale Income";
    ...
    public function pdf(Request $request, PdfService $pdf)
    {
        ...
        return $pdf
            ->make("reports.pdf.none-sale-income", array_merge(
                [
                    "shopId" => $shopId,
                    "startDate" => $startDate,
                    "endDate" => $endDate,
    ...
    public function excel(Request $request, ExcelService $excelService)
    {
        ...
        $sheetTitle = "None Sale Income {$startDate} to {$endDate}";
        $fileName = "none_sale_income_{$startDate}_{$endDate}.xlsx";

        return $excelService->export(
            view("reports.excel.none-sale-income", array_merge(
                [
                    "shopId" => $shopId,
                    "startDate" => $startDate,
                    "endDate" => $endDate,
