...
class DailyExpenseController extends Controller
{
    ...
    public function pdf(Request $request, PdfService $pdf)
    {
        ...
        return $pdf
            ->make("reports.pdf.daily-expense", array_merge(
                [
                    "shopId" => $shopId,
                    "startDate" => $startDate,
                    "endDate" => $endDate,
    ...
    public function excel(Request $request, ExcelService $excelService)
    {
        ...
        $sheetTitle = "Daily Expense {$startDate} to {$endDate}";
        $fileName = "daily_expense_{$startDate}_{$endDate}.xlsx";

        return $excelService->export(
            view("reports.excel.daily-expense", array_merge(
                [
                    "shopId" => $shopId,
                    "startDate" => $startDate,
                    "endDate" => $endDate,
